...
| **Potential Impact** | Compromise of the Forgejo git forge account `home`, enabling repository tampering (malicious commits that flow into the Docker image build), and — given the n8n PR-review pipeline in the environment — a pivot into the automation. |
